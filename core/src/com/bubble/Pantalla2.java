...
public class Pantalla2 extends PantallaBase {
    ...
    public Pantalla2(final Juego game) {
    ...
    public void show() {
        ...
        jugador  = new Jugador(world,game,jugadorTexture,new Vector2(1.5f,3.5f));
        enemigo1 = new Enemigo1(world,enemigo1Texture,new Vector2(14,2f));
        enemigo2 = new Enemigo2(world,enemigo2Texture,new Vector2(5.2f,4f));
        meta     = new Meta(world,metaTexture,new Vector2(16.5f,6f));


        suelos1.add(new Suelo1(world,suelo2Texture,new Vector2(1.5f,-1f)));
        suelos1.add(new Suelo1(world,suelo1Texture, new Vector2(9,-1.5f)));
        suelos1.add(new Suelo1(world,suelo1Texture, new Vector2(14f,-0.5f)));
        suelos1.add(new Suelo1(world,suelo2Texture, new Vector2(19f,1.5f)));

        suelos1.add(new Suelo1(world,techo1Texture, new Vector2(9,8)));
        suelos1.add(new Suelo1(world,techo1Texture, new Vector2(16,10)));
        suelos1.add(new Suelo1(world,techo1Texture, new Vector2(1.5f,9)));
        ...
        pinchos2.add(new Pincho2(world,pincho2Texture,new Vector2(3.5f,5.5f)));
        pinchos2.add(new Pincho2(world,pincho2Texture,new Vector2(7f,4.5f)));
        pinchos2.add(new Pincho2(world,pincho2Texture,new Vector2(14f,6.5f)));

        pinchos1.add(new Pincho1(world,pincho1Texture,new Vector2(11f,2f)));
        ...
        stage.addAction(
                Actions.sequence(
                        ...
                        Actions.run(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                game.setScreen(game.getPantalla3());
                            }
                        })
                )
        );
