 ...
 */
public class Pincho2 extends Actor {
    ...
    public Pincho2(World world, Texture texture, Vector2 position){
        ...
        vertices[2] = new Vector2(-0.50f,1f);

        PolygonShape shape = new PolygonShape();
        shape.set(vertices);
        fixture = body.createFixture(shape,1);
        fixture.setUserData("pincho2");
        shape.dispose();
