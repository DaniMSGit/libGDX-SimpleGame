...
public class Pantalla1 extends PantallaBase {
    ...
    private List<Pincho1>               pinchos  = new ArrayList<Pincho1>();
    ...
    public Pantalla1(final Juego game) {
    ...
    public void show() {
        ...
        Texture pinchosTexture  = game.getManager().get("pincho1.png");
        Texture metaTexture     = game.getManager().get("meta.png");


        //Definición de los actores

        jugador  = new Jugador(world,game,jugadorTexture,new Vector2(1.5f,6));
        enemigo1 = new Enemigo1(world,enemigo1Texture,new Vector2(9,1.5f));
        meta     = new Meta(world,metaTexture,new Vector2(16.5f,6.5f));


        suelos1.add(new Suelo1(world,suelo1Texture,new Vector2(1.5f,1)));
        suelos1.add(new Suelo1(world,suelo1Texture, new Vector2(9,-1)));
        suelos1.add(new Suelo1(world,suelo1Texture, new Vector2(16.5f,1)));
        suelos1.add(new Suelo1(world,techo1Texture, new Vector2(9,9)));
        ...
        pinchos.add(new Pincho1(world,pinchosTexture,new Vector2(3.5f,4.5f)));
        pinchos.add(new Pincho1(world,pinchosTexture,new Vector2(14.5f,4.5f)));
        ...
        for(Pincho1 pincho : pinchos){stage.addActor(pincho);}
        ...
        stage.addAction(
                Actions.sequence(
                        ...
                        Actions.run(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                game.setScreen(game.getPantalla2());
                            }
                        })
                )
        );
